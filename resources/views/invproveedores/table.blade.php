    ...
    @foreach($invproveedores as $invproveedores)
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    <a href="{!! route('invproveedores.show', [$invproveedores->id]) !!}" class='btn btn-info'><i class="far fa-eye"></i></a>
                    @can('invproveedores-edit')
                    <a href="{!! route('invproveedores.edit', [$invproveedores->id]) !!}" class='btn btn-primary'><i class="far fa-edit"></i></a>
                    @endcan
                    @can('invproveedores-delete')
                    {!! Form::button('<i class="fas fa-trash-alt"></i>', ['type' => 'button', 'class' => 'btn btn-danger', 'onclick' => "ConfirmDelete($invproveedores->id)"]) !!}
                    @endcan
                </div>
                {!! Form::close() !!}
            </td>
